...
#***********************************************************************************
# Funkcja SolveEuler: rozwiązywanie równania różniczkowego metodą Eulera
#***********************************************************************************
...
def SolveEuler(omega, x0, v0, tmax, dt):
...
res_t, res_x, res_v, res_exact, res_diff = SolveEuler(omega, x0, v0, tmax, dt)
